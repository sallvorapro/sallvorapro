...
export const TopHeader: React.FC<TopHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-gray-200/80 px-4 sm:px-6 py-3 flex items-center justify-between shadow-xs">
      {/* Brand Logo & Name */}
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        >
          <div className="w-5 h-5 rounded-full bg-[#00A651] text-white flex items-center justify-center text-[10px] font-extrabold">
            {user.avatarText || 'U'}
          </div>
